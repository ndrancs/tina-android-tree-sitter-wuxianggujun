...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [163] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(119),
  [166] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(90),
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2), SHIFT_REPEAT(116),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table_array_element, 5),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_table_array_element, 5),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table, 5),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_table, 5),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table_array_element, 4),
  [182] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_table_array_element, 4),
  ...
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 2),
  [202] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pair, 2),
  ...
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__basic_string, 2),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__literal_string, 2),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_document, 2),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_document_repeat2, 2),
  [237] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat2, 2), SHIFT_REPEAT(36),
  [240] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat2, 2), SHIFT_REPEAT(37),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__basic_string, 3),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__literal_string, 3),
  [247] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [249] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [251] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [253] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__multiline_literal_string_repeat1, 2), SHIFT_REPEAT(55),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__multiline_literal_string_repeat1, 2),
  ...
  [286] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__basic_string_repeat1, 2), SHIFT_REPEAT(66),
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__basic_string_repeat1, 2),
  [291] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [293] = {.entry = {.count = 1, .reusable = true}}, SHIFT(131),
  [295] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat2, 3),
  [297] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat2, 4),
  ...
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__multiline_basic_string, 2),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__multiline_literal_string, 2),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_table, 2),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__multiline_basic_string, 3),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__multiline_literal_string, 3),
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_table, 3, .production_id = 1),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 4),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inline_table, 4, .production_id = 1),
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 5),
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 6),
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 7),
  [333] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 8),
  ...
  [349] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat2, 2),
  ...
  [359] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat2, 2), SHIFT_REPEAT(22),
  [362] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quoted_key, 1),
  ...
  [374] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_inline_table_repeat1, 2), SHIFT_REPEAT(35),
  [377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_inline_table_repeat1, 2),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dotted_key, 3),
  [381] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_inline_table_repeat1, 2, .production_id = 1),
  ...
  [391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__inline_pair, 3),
